...
- 'step5_result.txt': The data set.

- 'run_analysis.R': Script use to generates the 'step5_result.txt' file from the original data. See README.md file for instructions about the scripts.
...
Finally the mean was calculated for each activity and each subject. 
